...
export class BeneficioService {
  ...
  private readonly API_TRANSPORTES = 'http://localhost:8090/api/transitos/transportes';
  private readonly API_TRANSPORTISTAS = 'http://localhost:8090/api/transitos/transportistas';
...
listarTransportistas(): Observable<Transportista[]> {
  return this.http.get<Transportista[]>(
    this.API_TRANSITOS
  );
}
